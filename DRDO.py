...
#making animation
image_a=ImageTk.PhotoImage(Image.open('D:/python/Image/c2.png'))
image_b=ImageTk.PhotoImage(Image.open('D:/python/Image/c1.png'))

#xyma imgae
xyma_img = Image.open("D:/python/Image/xyma.png")
xyma_img = ImageTk.PhotoImage(xyma_img)
 
#drdo image
drdo_img = Image.open("D:/python/Image/drdo1.png")
...
def save_data_to_csv_with_dialog(aa, bb, cc, dd):
    ...
    if result:
        ...
        file_path = f"D:/python/data_directory/{result}.csv"
...
def openbutton():
    ...
    def on_combobox_select(event):
        ...
        if selected_value:
            for ax in axes:
                 ax.cla()
            # Construct the full file path
            file_path = f"D:/python/data_directory/{selected_value}.csv"
    ...
    directory_path = r'D:\python\data_directory'
...
def new_win():
    ...
    xyma_img1 = Image.open("C:/python/Image/xyma_final.png")
    xyma_img1=ImageTk.PhotoImage(xyma_img1)
    drdo_img = Image.open("C:/python/Image/drdo_final.png")
    drdo_img = ImageTk.PhotoImage(drdo_img)
